    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="shrink-0">
                    <img class="size-8" src="\img\arknight.png" alt="Arknight">
                    <audio id="OST" autoplay loop>
                        <source src="/audio/Babel Lobby Theme.MP3" type="audio/mp3" />
                    </audio>
                    <script>
                        var x = document.getElementById("OST").volume = 0.3;
                    </script>
                </div>
                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button" @click="isOpen = !isOpen"
                                ...
                                <img class="size-8 rounded-full" src="/img/theresa.png" alt="">
                            </button>
                        </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
                <div class="shrink-0">
                    <img class="size-10 rounded-full" src="/img/Theresa.png" alt="theresa">
                </div>
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Theresa</div>
                    <div class="text-sm font-medium text-gray-400">ig:arknights_messenger_official</div>
                </div>
            </div>
