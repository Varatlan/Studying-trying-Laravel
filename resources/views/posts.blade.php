            ...
            <form>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input
                            class="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border 
                    ...
                    <div>
                        ...
                        focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                            <img src="/img/search.png" alt="search" width="26px">
                        </button>
                    </div>
                </div>
            </form>
                ...
                <article
                    ...
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        <a href="/posts?category/{{ $post->category->slug }}">
                            ...
                            items-center px-2.5 py-0.5 rounded dark:bg-primary-200 
                    ...
                    <a href="/posts/{{ $post->slug }}"class="hover:underline text-base">
                        <h2
